...
function Stay ({usState, setUSState}) {
    ...
    let shuffledDestination = ''
      console.log(usState);
    if (usState === 'utah' ) {
         shuffledDestination = utah.sort(function(){return .5 - Math.random()});
    } if (usState === 'idaho' ) {
         shuffledDestination = idaho.sort(function(){return .5 - Math.random()});
    } if (usState === 'california' ) {
         shuffledDestination = california.sort(function(){return .5 - Math.random()});
    } if (usState === 'arizona' ) {
         shuffledDestination = arizona.sort(function(){return .5 - Math.random()});
    } if (usState === 'nevada' ) {
         shuffledDestination = nevada.sort(function(){return .5 - Math.random()});
    } if (usState === 'washington' ) {
        shuffledDestination = washington.sort(function(){return .5 - Math.random()});
    } if (usState === 'oregon' ) {
        shuffledDestination = oregon.sort(function(){return .5 - Math.random()});
   } else {
        console.log('error')
   }
    ...
    let capitolized = usState.charAt(0).toUpperCase() + usState.slice(1);
        ...
        <div>
            ...
            <Container>
                ...
                <Row className="mb-4">
                    ...
                    <Col>
                     <div className='mb-2'>What state are you thinking of visiting? </div>
                     <Input type="select" onChange={handleChange}>
                        <option key="1" value="utah">Utah</option>
                        <option key="2" value='idaho' >Idaho</option>
                        <option key="3" value='california' >California</option>
                        <option key="4" value='arizona' >Arizona</option>
                        <option key="5" value='nevada' >Nevada</option>
                        <option key="6" value='washington' >Washington</option>
                        <option key="7" value='oregon' >Oregon</option>
